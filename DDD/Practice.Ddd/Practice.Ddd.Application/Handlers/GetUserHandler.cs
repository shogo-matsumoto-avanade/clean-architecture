...
public class GetUserHandler : IRequestHandler<GetUserQuery, IUserModel>
{
    ...
    /// <returns></returns>
    Task<IUserModel> IRequestHandler<GetUserQuery, IUserModel>.Handle(GetUserQuery request, CancellationToken cancellationToken)
    {
